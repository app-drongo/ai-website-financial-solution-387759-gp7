...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Empowering businesses with innovative financial solutions and cutting-edge technology. Trusted by thousands of companies worldwide for secure, scalable, and intelligent financial management.',
  contactEmail: 'contact@financeflow.com',
  contactPhone: '+1 (555) 234-5678',
  contactAddress: '456 Financial District, Suite 200',
  newsletterTitle: 'Financial Insights',
  newsletterPlaceholder: 'Enter your business email',
  newsletterDisclaimer:
    'Get exclusive financial insights and product updates. Secure and professional communications only.',
  section1Title: 'Solutions',
  section2Title: 'Company',
  section3Title: 'Support',
  section4Title: 'Compliance',
  copyrightText: '© 2024 FinanceFlow. All rights reserved.',
  madeWithText: 'by financial experts',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/financeflow',
  social2Href: 'https://facebook.com/financeflow',
  social3Href: 'https://instagram.com/financeflow',
  social4Href: 'https://linkedin.com/company/financeflow',
  social5Href: 'https://github.com/financeflow',
} as const;
