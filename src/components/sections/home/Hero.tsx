...
const DEFAULT_HERO = {
  badge: 'New: Advanced Financial Platform',
  title: 'Transform your business with',
  titleHighlight: 'intelligent financial solutions',
  description:
    'Streamline operations, optimize cash flow, and make data-driven decisions with our comprehensive financial management platform designed for modern businesses.',
  features: [
  ...
  statsLabel1: 'Accuracy',
  statsValue1: '99.9% uptime',
  statsLabel2: 'Compliance',
  statsValue2: 'SOX certified',
} as const;
