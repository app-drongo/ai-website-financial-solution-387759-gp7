...
const DEFAULT_CONTACT = {
  ...
  mainTitleHighlight: 'Financial Future?',
  mainDescription:
    'Our financial experts are here to help you achieve your goals. Get in touch today for a personalized consultation and discover how our solutions can work for you.',
  formTitle: 'Get Your Free Consultation',
  formDescription:
    'Complete the form below and one of our financial advisors will contact you within 24 hours to discuss your needs.',
  submitButton: 'Request Consultation',
  contactSectionTitle: 'Speak With Our Team',
  method1Title: 'Email Support',
  method1Description: 'Secure financial inquiries',
  method1Contact: 'advisors@financeflow.com',
  method2Title: 'Direct Line',
  method2Description: 'Speak with an advisor',
  method2Contact: '+1 (555) 789-0123',
  method3Title: 'Live Support',
  method3Description: 'Instant financial guidance',
  method3Contact: 'Available 9 AM - 8 PM EST',
  officesSectionTitle: 'Our Financial Centers',
  office1City: 'New York',
  office1Address: 'Wall Street Financial District, Suite 2500',
  office1Timezone: 'EST (UTC-5)',
  office2City: 'Chicago',
  office2Address: 'LaSalle Street Financial Center, Floor 18',
  office2Timezone: 'CST (UTC-6)',
  office3City: 'San Francisco',
  office3Address: 'Montgomery Street Financial Plaza, Suite 1200',
  office3Timezone: 'PST (UTC-8)',
  hoursTitle: 'Advisory Hours',
  ...
  hoursSundayTime: 'By Appointment',
  supportNote: '24/7 emergency support available for Premium clients',
  nameLabel: 'Full Name *',
  ...
  messagePlaceholder:
    'Tell us about your financial goals, investment interests, or any questions you have about our services...',
} as const;
